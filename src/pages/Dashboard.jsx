        ...
        return (
            <div className="flex items-center justify-center h-screen">
                <div className="text-center">
                    ...
                    <p className="text-light-text-secondary dark:text-light-text-secondary">Loading dashboard...</p>
                </div>
            </div>
        );
    }
        ...
        return (
            <div className="flex items-center justify-center h-screen">
                <div className="text-center">
                    ...
                    <p className="text-light-text dark:text-light-text mb-4">{error}</p>
                    <button
    ...
    return (
        <div className="space-y-6 animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    <h1 className="text-3xl font-bold text-light-text dark:text-light-text mb-2">Dashboard</h1>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                {stats.map((stat, index) => (
                    <div
                        key={index}
                        className="bg-white dark:bg-white border border-light-border dark:border-light-border rounded-2xl p-6 hover:border-primary-500 transition-all duration-300 hover:shadow-lg hover:shadow-primary-500/10 hover:-translate-y-1 group"
                    >
                        ...
                        <div className="text-3xl font-bold text-light-text dark:text-light-text mb-1">{stat.value}</div>
                        <div className="text-sm text-light-text-secondary dark:text-light-text-secondary mb-1">{stat.label}</div>
                        <div className="text-xs text-light-text-secondary/70 dark:text-light-text-secondary/70">{stat.subtitle}</div>
                    </div>
                ))}
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                <div className="bg-white dark:bg-white border border-light-border dark:border-light-border rounded-xl p-4">
                    <div className="flex items-center justify-between">
                        <div>
                            <p className="text-sm text-light-text-secondary dark:text-light-text-secondary">Today's Assignments</p>
                            <p className="text-2xl font-bold text-light-text dark:text-light-text">{assignments.today}</p>
                        </div>
                ...
                <div className="bg-white dark:bg-white border border-light-border dark:border-light-border rounded-xl p-4">
                    <div className="flex items-center justify-between">
                        <div>
                            <p className="text-sm text-light-text-secondary dark:text-light-text-secondary">This Month</p>
                            <p className="text-2xl font-bold text-light-text dark:text-light-text">{assignments.thisMonth}</p>
                        </div>
                ...
                <div className="bg-white dark:bg-white border border-light-border dark:border-light-border rounded-xl p-4">
                    <div className="flex items-center justify-between">
                        <div>
                            <p className="text-sm text-light-text-secondary dark:text-light-text-secondary">Today's Revenue</p>
                            <p className="text-2xl font-bold text-light-text dark:text-light-text">
                ...
                <div className="bg-white dark:bg-white border border-light-border dark:border-light-border rounded-xl p-4">
                    <div className="flex items-center justify-between">
                        <div>
                            <p className="text-sm text-light-text-secondary dark:text-light-text-secondary">Month Revenue</p>
                            <p className="text-2xl font-bold text-light-text dark:text-light-text">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                {serviceDistribution.length > 0 && (
                    <div className="bg-white dark:bg-white border border-light-border dark:border-light-border rounded-2xl p-6 hover:border-primary-500 transition-all duration-300">
                        <h3 className="text-lg font-bold text-light-text dark:text-light-text mb-6">
                            Popular Services
                        </h3>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                {/* Recent Assignments */}
                <div className="bg-white dark:bg-white border border-light-border dark:border-light-border rounded-2xl p-6 hover:border-primary-500 transition-all duration-300">
                    <h3 className="text-lg font-bold text-light-text dark:text-light-text mb-6">Recent Assignments</h3>
                    <div className="space-y-4">
                        {recentActivity.assignments?.filter(assignment =>
                            ...
                            <div
                                key={assignment._id}
                                className="flex items-center justify-between p-4 bg-light-bg dark:bg-light-bg rounded-xl hover:bg-light-surface-hover dark:hover:bg-light-surface-hover transition-colors duration-200"
                            >
                                <div className="flex-1">
                                    <div className="flex items-center gap-3 mb-2">
                                        <span className="text-sm font-semibold text-light-text dark:text-light-text">
                                    ...
                                    <div className="flex items-center gap-4 text-xs text-light-text-secondary dark:text-light-text-secondary">
                        ...
                        <div className="space-y-4">
                            {performance.paymentBreakdown.map((payment, index) => {
                                ...
                                return (
                                    <div
                                        key={index}
                                        className="p-4 bg-light-bg dark:bg-light-bg rounded-xl hover:bg-light-surface-hover dark:hover:bg-light-surface-hover transition-colors duration-200"
                                    >
                                        <div className="flex items-center justify-between mb-2">
                                            <span className="text-sm font-semibold text-light-text dark:text-light-text capitalize">
                                                {payment._id || 'Unknown Method'}
                                            </span>
                                            <span className="text-sm text-light-text-secondary dark:text-light-text-secondary">
                                                {payment.count} transactions
                                            </span>
                                        </div>
                                        <div className="flex items-center justify-between mb-2">
                                            <span className="text-xs text-light-text-secondary dark:text-light-text-secondary">
                                        ...
                                        <div className="text-xs text-right text-light-text-secondary dark:text-light-text-secondary mt-1">
