...
const Header = ({ toggleSidebar }) => {
    ...
    return (
        <header className={`bg-transparent backdrop-blur-sm fixed top-0 left-0 md:left-72 right-0 h-[70px] border-b flex items-center justify-between px-4 sm:px-6 z-30 transition-all duration-300 ${isDark
